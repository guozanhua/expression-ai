...
eye_cascade = cv2.CascadeClassifier('E:\\opencv\\build\\etc\\haarcascades\\haarcascade_eye.xml')
eye_glasses_cascade = cv2.CascadeClassifier('E:\\opencv\\build\\etc\\haarcascades\\haarcascade_eye_tree_eyeglasses.xml')
...
while cap.isOpened():
	...
	# 	metrics=['accuracy'])
	# predictions = model.predict_classes(format_image(img))
